...
class LeaveApprovalResourceCollection extends ResourceCollection
{
    public $collects = LeaveApprovalResource::class;
    ...
    public function toArray(Request $request): array
    {
        ...
        return $this->collection->map(function ($approval) use ($idToName, $request) {
            $base = (new LeaveApprovalResource($approval))->toArray($request);
